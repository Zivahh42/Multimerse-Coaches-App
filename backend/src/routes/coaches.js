...
import { parseCoach } from '../validators.js';
import { nanoid } from 'nanoid';

const router = Router();

// (Optional) Request logger to debug incoming bodies
router.use((req, _res, next) => {
  // console.log(req.method, req.originalUrl, req.body);
  next();
});

// GET /coaches (with optional search & category filtering via query params)
